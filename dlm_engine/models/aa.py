...
from dlm_engine.errors import PermError, CredentialError, SessionCredentialError, AdminError
from dlm_engine.errors import SessionError
...
class AuthenticationAuthorization(object):
    ...
    async def require(self, request, permission=None):
